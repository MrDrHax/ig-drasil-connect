...
import { UsersIcon, CogIcon, CheckCircleIcon, ExclamationCircleIcon, ClockIcon, ChevronLeftIcon, ChevronRightIcon, ArrowPathIcon } from "@heroicons/react/24/solid";
      ...
      <div className="mt-12 mb-8 flex flex-col gap-12">
        <Card className={`${getTypography()} ${getBgColor("background-cards")}`}>
          <CardHeader variant="gradient" color="gray" className={`mb-8 p-6 flex ${getBgColor("search-bar")}`}>
            ...
            <div className="mr-10 md:mr-10 md:w-56 flex items-center space-x-2">
              {/* Search bar by name*/}
              <Input
                color="white"
              ...
              <Button onClick={() => updateData()} color="gray" variant="gradient">
